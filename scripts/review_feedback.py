...
def build_entry(
    date: str, source: str, summary: str, actions: list[str], next_items: list[str]
) -> str:
    action_lines = (
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--source", required=True, help="Feedback source (example: Grok 4.20 Beta)"
    )
    parser.add_argument(
        "--summary", required=True, help="One-line summary of the feedback"
    )
    parser.add_argument(
        "--actions",
        action="append",
    ...
    parser.add_argument(
        "--date", default=utc_day(), help="Date label in YYYY-MM-DD format"
    )
    parser.add_argument(
        "--file",
